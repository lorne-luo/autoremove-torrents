...
site_name = "hdarea"
site_url = "https://hdarea.club/torrents.php"
site_cookie = "c_lang; c_secure_uid=MTIzNDk0; c_secure_pass=7aa59fec74c5dfc1bd21e09f154269e2; c_secure_ssl=eWVhaA%3D%3D; c_secure_tracker_ssl=eWVhaA%3D%3D; c_secure_login=bm9wZQ%3D%3D; _gid=GA1.2.160607903.1691386099; _ga_P7FXS6LFMX=GS1.1.1691567267.42.1.1691568054.0.0.0; _ga=GA1.1.882319756.1690245658"
...
monitor_path = r'/Users/lorneluo/Downloads'
...
referer = 'https://hdarea.club/login.php'
host = 'hdarea.club'
referer = ''
host = ''
...
class Torrents():
    ...
    def download(self):
        ...
        '''
        down_url = domain + self.torrent[3] #+ url_last
        if self.torrent[0]:
